...
func main() {
	r := gin.Default()
	api := kavenegar.New(os.Getenv("326B4B4F5067427933384F4365565962536B79363751785949657054464E387A3833443645414F4D4E6F773D"))
	sender := ""
	receptor := []string{os.Getenv("09128691624")}
